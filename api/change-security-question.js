// API endpoint to change security question (requires password verification)
...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Encrypt and save new security question/answer
        ...
        return res.status(200).json({ success: true, message: 'Security question changed successfully' });
    } catch (error) {
        console.error('change-security-question error:', error);
